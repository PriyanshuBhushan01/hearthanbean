...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      { title: "Gallery — Hearth & Bean" },
      { name: "description", content: "Step inside Hearth & Bean — coffee drinks, baristas at work, café ambiance and seasonal food in photos." },
      { property: "og:title", content: "Gallery — Hearth & Bean" },
      { property: "og:description", content: "A visual walk through Hearth & Bean." },
