...
function Home() {
  ...
  const testimonials = [
    ...
    { name: "Daniel K.", quote: "Hearth & Bean feels like a friend's living room — but with better coffee.", rating: 5 },
    ...
    <Layout>
      ...
      <section className="relative isolate overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <img src={hero} alt="Hearth & Bean cafe interior at golden hour" width={1920} height={1080} className="h-full w-full object-cover" />
        ...
        <div className="container-page min-h-[88dvh] flex items-center py-24">
          <div className="max-w-2xl text-cream animate-fade-up">
            ...
            <p className="mt-6 max-w-lg text-base sm:text-lg text-cream/80 leading-relaxed">
              Single-origin beans, slow rituals, and a warm seat by the window. Every cup at Hearth & Bean is poured with patience and a quiet kind of love.
            </p>
