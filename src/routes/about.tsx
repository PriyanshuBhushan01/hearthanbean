...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "Our Story — Hearth & Bean" },
      { name: "description", content: "Hearth & Bean began as a tiny corner roastery in Brooklyn. Today we serve ethically sourced, handcrafted coffee with a passion for sustainability." },
      { property: "og:title", content: "Our Story — Hearth & Bean" },
      ...
      <section className="container-page py-20 md:py-28">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div className="animate-fade-up">
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">Hearth & Bean started in 2014 as a single roaster in a Williamsburg garage. Ten years on, we still roast every bean ourselves — small batch, every week — because we believe a good cup begins long before the espresso pulls.</p>
