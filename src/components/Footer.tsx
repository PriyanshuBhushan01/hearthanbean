    ...
    <footer className="mt-24 border-t border-border bg-secondary/40">
      <div className="container-page py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-1">
          <div className="flex items-center gap-2">
            <img src={logo} alt="Hearth & Bean" className="h-9 w-9 object-contain" />
            <span className="font-serif text-2xl font-semibold">Hearth & Bean</span>
          </div>
      ...
      <div className="border-t border-border">
        <div className="container-page py-6 text-xs text-muted-foreground flex flex-wrap justify-between gap-3">
          <span>© {new Date().getFullYear()} Hearth & Bean. All rights reserved.</span>
